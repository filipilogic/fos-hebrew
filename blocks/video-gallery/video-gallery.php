...
$class = 'il_block il_video_gallery';
...
$col_in_class = 'il_video_gallery_container container';

if ( ! empty( $enable_slider) ) {
...
<?php get_template_part('components/background'); ?>
	...
	?>
        ...
        ?>
        <div class="il_video_gallery_inner <?php if($open_images_in_lightbox) { echo 'images-lightbox'; } ?>">
        <?php
            ...
            if( have_rows('columns_block') ):
                ...
                <div class="il_col column">
                    <?php if($open_images_in_lightbox && !empty($video_link)) { ?>
                        <a href="<?php echo esc_url($video_link); ?>" data-fancybox="<?php echo esc_attr($fancybox_data); ?>">
